...
import CohortFeature from '@/components/features/CohortFeature'
...
export default function Page() {
  ...
  return <div className="space-y-4"><div><h1 className="text-lg font-bold text-zinc-800">연도별 성장률 (코호트)</h1><p className="text-sm text-zinc-500 mt-0.5">연도별 매출 성장률을 분석합니다.</p></div><CohortFeature /></div>
}
